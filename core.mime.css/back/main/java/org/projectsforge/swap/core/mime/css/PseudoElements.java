 ...
 * <http://www.gnu.org/licenses/>. $Id: PseudoElements.java 90 2011-06-21
 * 17:29:12Z sebtic $
 */
...
/**
 * The Class PseudoElements.
 * 
 * @author Sébastien Aupetit
 */
public final class PseudoElements {
  ...
  static {
    ...
    list.add(PseudoElements.FIRST_LETTER);
    list.add(PseudoElements.FIRST_LINE);
    list.add(PseudoElements.BEFORE);
    list.add(PseudoElements.AFTER);
    allSets = PseudoElements.generateAllSets(list);
  }

  /**
   * Generate all sets of pseudo elements.
   * 
   * @param list the list
   * @return the list
   */
  ...
  /**
   * Instantiates a new pseudo elements.
   */
