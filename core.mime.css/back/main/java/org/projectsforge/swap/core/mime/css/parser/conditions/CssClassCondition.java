 ...
 * 
 * $Id: CssClassCondition.java 84 2011-06-09 10:09:03Z sebtic $
 */
...
/**
 * The Class CssClassCondition.
 */
public class CssClassCondition extends AbstractCssAttributeCondition {

  /**
   * Instantiates a new css class condition.
   * 
   * @param value
   *          the value
   */
  public CssClassCondition(final String value) {
    super(null, value);
  }
