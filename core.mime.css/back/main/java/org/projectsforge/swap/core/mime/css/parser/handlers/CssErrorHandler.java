...
public class CssErrorHandler implements ErrorHandler {
   ...
   * @param uri the uri
   */
  public CssErrorHandler(final String uri) {
    logger = org.slf4j.LoggerFactory
        .getLogger(CssErrorHandler.class.getCanonicalName() + "." + uri);
  }
  ...
  public void error(final CSSParseException exception) throws CSSException {
    logger.info(
        "Parse error at {}:{} ({})",
        new Object[] { exception.getColumnNumber(), exception.getLineNumber(),
