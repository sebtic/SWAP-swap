...
/**
 * The interface RuleSetProcessor which allows to do computation of CSS
 * properties.
 * 
 * @author Sébastien Aupetit
 */
public interface RuleSetProcessor {

  /**
   * Process a rule set for an element.
   * 
   * @param resolverState the resolver state
   * @param rules the rules applicable to the element from first encountered to
   *          last encountered
   */
  void process(ResolverState resolverState, CssRule[] rules);
