 ...
 * <http://www.gnu.org/licenses/>. $Id: CssOneOfAttributeCondition.java 84
...
/**
 * The Class CssOneOfAttributeCondition representing conditions of the form
 * [attrib~="value"].
 * 
 * @author Sébastien Aupetit
 */
public class CssOneOfAttributeCondition extends AbstractCssAttributeCondition {

  /**
   * Instantiates a new css one of attribute condition.
   * 
   * @param localName the local name
   * @param value the value
   */
  public CssOneOfAttributeCondition(final ICaseString localName, final String value) {
