/*
 * ICodepageDetector.java cpdetector Copyright (C) Achim Westermann, created on
 * 19.07.2004, 20:13:44 ***** BEGIN LICENSE BLOCK ***** Version: MPL 1.1/GPL
...
public interface ICodepageDetector extends Comparable<ICodepageDetector> {
   ...
   * @param length The amount of bytes to take into account. This number should
