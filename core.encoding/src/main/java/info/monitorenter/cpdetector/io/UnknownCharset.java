/*
 * UnknownCharset.java cpdetector Copyright (C) Achim Westermann, created on
 * 26.09.2004, 03:15:15 ***** BEGIN LICENSE BLOCK ***** Version: MPL 1.1/GPL
...
/**
 * A singleton Charset indicating that no encoding could be detected at all
 * (regardless wether supported by platform or not). Unlike the
 * {@link UnsupportedCharset} singleton instances it will never equal anything.
 * <p>
 * 
