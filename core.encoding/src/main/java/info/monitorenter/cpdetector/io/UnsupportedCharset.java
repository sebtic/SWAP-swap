 ...
 * executable. Copyright (C) Achim Westermann, created on 20.07.2004, 12:17:13
 * ***** BEGIN LICENSE BLOCK ***** Version: MPL 1.1/GPL 2.0/LGPL 2.1 The
 * contents of this collection are subject to the Mozilla Public License Version
...
public class UnsupportedCharset extends Charset {
  ...
  private static Map<String, Charset> singletons = new HashMap<>();
  ...
  private UnsupportedCharset(final String name) {
    super(name, null);
