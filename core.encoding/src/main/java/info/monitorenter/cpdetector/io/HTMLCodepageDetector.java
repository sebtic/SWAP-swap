/*
 * HTMLCodepageDetector.java, a facade to an ANTLR grammar based parser / lexer
 * that searches for the "charset" attribute of a html page. Copyright (C) 2004
 * Achim Westermann, created on 20.07.2004, 10:35:46 ***** BEGIN LICENSE BLOCK
 * ***** Version: MPL 1.1/GPL 2.0/LGPL 2.1 The contents of this collection are
 * subject to the Mozilla Public License Version 1.1 (the "License"); you may
 * not use this file except in compliance with the License. You may obtain a
 * copy of the License at http://www.mozilla.org/MPL/ Software distributed under
 * the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY KIND,
 * either express or implied. See the License for the specific language
 * governing rights and limitations under the License. The Original Code is the
 * cpDetector code in [sub] packages info.monitorenter and cpdetector. The
 * Initial Developer of the Original Code is Achim Westermann
...
public class HTMLCodepageDetector extends AbstractCodepageDetector {
   ...
   */
  private final ParsingDetector delegate;

  public HTMLCodepageDetector() {
    this(false);
  }

  public HTMLCodepageDetector(final boolean verbose) {
    super();
