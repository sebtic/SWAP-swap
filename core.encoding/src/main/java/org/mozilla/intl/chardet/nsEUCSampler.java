 ...
 * Original Code is mozilla.org code. The Initial Developer of the Original Code
 * is Netscape Communications Corporation. Portions created by the Initial
 * Developer are Copyright (C) 1998 the Initial Developer. All Rights Reserved.
...
public class nsEUCSampler {
  ...
  float GetScore(final float[] aFirstByteFreq, final float aFirstByteWeight,
      final float[] aSecondByteFreq, final float aSecondByteWeight) {
