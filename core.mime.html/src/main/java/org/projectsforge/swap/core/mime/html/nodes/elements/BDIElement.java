 ...
 */
@HtmlTag
public class BDIElement extends AbstractElement {
  /** The Constant TAGNAME. */
  public static final ICaseString TAGNAME = new ICaseString("bdi");

  /**
   * Instantiates a new bDI element.
   */
  protected BDIElement() {
  }
}
