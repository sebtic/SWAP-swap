 ...
 */
@HtmlTag
public class DETAILSElement extends AbstractElement {
  /** The Constant TAGNAME. */
  public static final ICaseString TAGNAME = new ICaseString("details");

  /**
   * Instantiates a new dETAILS element.
   */
  protected DETAILSElement() {
  }
}
