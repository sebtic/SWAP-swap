 ...
 */
@HtmlTag
public class WBRElement extends AbstractElement {
  /** The Constant TAGNAME. */
  public static final ICaseString TAGNAME = new ICaseString("wbr");

  /**
   * Instantiates a new wBR element.
   */
  protected WBRElement() {
  }
}
