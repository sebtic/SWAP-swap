 ...
 * <http://www.gnu.org/licenses/>. $Id: PElement.java 84 2011-06-09 10:09:03Z
 * sebtic $
 */
...
public class PElement extends AbstractElement {
  ...
  public static final ICaseString TAGNAME = new ICaseString("p");

  /**
   * Instantiates a new p element.
   */
  protected PElement() {
  }
