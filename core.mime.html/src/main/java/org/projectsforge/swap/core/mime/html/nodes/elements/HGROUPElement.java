 ...
 */
@HtmlTag
public class HGROUPElement extends AbstractElement {
  /** The Constant TAGNAME. */
  public static final ICaseString TAGNAME = new ICaseString("hgroup");

  /**
   * Instantiates a new hGROUP element.
   */
  protected HGROUPElement() {
  }
}
