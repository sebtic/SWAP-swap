 ...
 * <http://www.gnu.org/licenses/>. $Id: SElement.java 84 2011-06-09 10:09:03Z
 * sebtic $
 */
...
public class SElement extends AbstractElement {
  ...
  public static final ICaseString TAGNAME = new ICaseString("s");

  /**
   * Instantiates a new s element.
   */
  protected SElement() {
  }
