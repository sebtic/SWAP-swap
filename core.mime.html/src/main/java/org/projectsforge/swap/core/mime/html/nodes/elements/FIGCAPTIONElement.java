 ...
 */
@HtmlTag
public class FIGCAPTIONElement extends AbstractElement {
  /** The Constant TAGNAME. */
  public static final ICaseString TAGNAME = new ICaseString("figcaption");

  /**
   * Instantiates a new fIGCAPTION element.
   */
  protected FIGCAPTIONElement() {
  }
}
