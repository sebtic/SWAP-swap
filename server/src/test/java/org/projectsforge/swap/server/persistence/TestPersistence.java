package org.projectsforge.swap.server.persistence;

import java.net.URL;
import junit.framework.Assert;
import org.junit.Test;
import org.projectsforge.swap.server.persistence.data.Data;
import org.projectsforge.swap.server.persistence.repository.PersistenceTestingDataRepository;
...
public class TestPersistence {
  ...
  /** The logger. */
  private final Logger logger = LoggerFactory.getLogger(TestPersistence.class);
